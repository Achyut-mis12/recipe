...
let getData=async()=>{
  let res = await fetch(`https://api.edamam.com/search?q=${searchvalue}&app_id=a0ab596c&app_key=a8cb118340a018e4d1675edb0c4a0886`)
...
const handlesearch=(e)=>{
 ...
 <div>
    ...
    <label htmlFor="" className='d-flex justify-content-center gap-3'>
      <input ref={inputRef} className='col-3 rounded' type="text" name="" id="" placeholder='Search for recipes...' />
      <button onClick={handlesearch} className='btn btn-success rounded-2 ps-4 pe-4'>Search</button>
    </label>
  </div>
